...
public class Mitrailleuse extends Missiles {
    ...
    public void dessine(Graphics g){
        ...
        g.fillPolygon(new int[]{(int)(x+r*Math.cos(Math.toRadians(vtheta))),(int)(x+r*Math.cos(Math.toRadians(vtheta+120))),(int)(x+r*Math.cos(Math.toRadians(vtheta-120)))},
